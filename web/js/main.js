...
requirejs(['knockout', './app', 'lscache', 'director', 'cache-flush', 'drug-label', 'exposure-summary', 'faceted-datatable', 'home', 'search', 'search-results', 'condition-concept-by-index', 'drug-era-report','openFDA'], function (ko, app) {
