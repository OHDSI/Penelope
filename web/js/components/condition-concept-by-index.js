define(['knockout', 'text!./condition-concept-by-index.html','d3', 'jnj_chart'], function (ko, view, d3, jnj_chart) {
	function conceptByIndex(params) {
		...
		self.render = function () {
			$('#condition-concept-by-index-caption').html('First Condition Occurrence Of ' + self.conceptName() + ' Relative To Index');
			
			// If there is no concept specified, there is no need to retrieve the data....
			if (self.conceptId() == null)
				return;
